...
class IuLilkaFragmentThree: Fragment() {
    ...
    override fun onCreateView(
        ...
        val view: View = inflater.inflate(R.layout.iulilkafragment_three, container, false)
        ...
        val recyclerView = view.findViewById<RecyclerView>(R.id.iu_lilka_recycler_view_three)
...
class FragmentRecyclerViewAdapterThree(
    val iuLilkaImageTextList: IuLilkaImageTextList,
) : RecyclerView.Adapter<FragmentRecyclerViewAdapterThree.ViewHolder>() {
