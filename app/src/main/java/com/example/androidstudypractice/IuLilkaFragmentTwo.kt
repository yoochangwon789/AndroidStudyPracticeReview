...
class IuLilkaFragmentTwo: Fragment() {
    ...
    override fun onCreateView(
        ...
        val view: View = inflater.inflate(R.layout.iulilkafragment_two, container, false)
        ...
        val recyclerView = view.findViewById<RecyclerView>(R.id.iu_lilka_recycler_view_two)
...
class FragmentRecyclerViewAdapterTwo(
    val iuLilkaImageTextList: IuLilkaImageTextList,
) : RecyclerView.Adapter<FragmentRecyclerViewAdapterTwo.ViewHolder>() {
